...
import {Award, Calendar, Phone, User} from 'lucide-react';
    ...
    const achievements = [
        {
            ...
            value: `${config.stats.experience}+ ${t('about.years')}`
        },
        {
            icon: User,
            title: t('about.customers'),
            value: `${config.stats.happyCustomers}+`
        },
        {
            icon: Award,
            title: t('about.rating'),
            value: `${config.stats.customerSatisfaction}/5`
        }
    ];
