...
const AdminDashboard: React.FC<AdminDashboardProps> = ({onLogout}) => {
    ...
    const handleSeedData = async () => {
        if (!window.confirm('Test verileri eklenecek. Onaylıyor musunuz?')) return;

        try {
            const sampleProducts = [
                {
                    title: {tr: 'Luxury Villa in Antalya', en: 'Luxury Villa in Antalya'},
                    description: {
                        tr: 'Deniz manzaralı lüks villa, özel havuzlu',
                        en: 'Luxury villa with sea view and private pool'
                    },
                    price: 2500000,
                    currency: 'TRY',
                    ...
                    features: {tr: ['5+1', 'Deniz manzarası', 'Özel havuz'], en: ['5+1', 'Sea view', 'Private pool']}
                },
                {
                    title: {tr: '2018 BMW 3.20i', en: '2018 BMW 3.20i'},
                    description: {
                        tr: 'Temiz kullanılmış, full bakımlı BMW',
                        en: 'Well-maintained BMW in excellent condition'
                    },
                    price: 850000,
                    currency: 'TRY',
                    category: 'vehicles' as ProductCategory,
                    ...
                    features: {
                        tr: ['Otomatik vites', 'Deri döşeme', 'Sunroof'],
                        en: ['Automatic', 'Leather interior', 'Sunroof']
                    }
                },
                {
                    title: {tr: 'İnşaat Demiri 14mm', en: 'Construction Steel 14mm'},
                    description: {
                        tr: 'Kaliteli inşaat demiri, toptan satış',
                        en: 'High-quality construction steel, wholesale'
                    },
                    price: 25,
                    currency: 'TRY',
                    priceText: '25 TL/kg',
                    category: 'construction' as ProductCategory,
                    ...
                    features: {tr: ['A400 kalite', 'Nervürlü'], en: ['A400 grade', 'Ribbed']}
                },
                {
                    title: {tr: 'Organik Yumurta', en: 'Organic Eggs'},
                    description: {tr: 'Köy yumurtası, organik beslenme', en: 'Village eggs, organic feed'},
                    price: 15,
                    currency: 'TRY',
                    priceText: '15 TL/düzine',
                    category: 'farm' as ProductCategory,
                    images: ['https://images.unsplash.com/photo-1574593029002-334d3dccf6b3?w=800&q=80'],
                    featured: false,
                    inStock: true,
                    views: Math.floor(Math.random() * 150) + 30,
                    location: {tr: 'Muratpaşa, Antalya', en: 'Muratpasa, Antalya'},
                    features: {tr: ['Antibiyotiksiz', 'Serbest gezinme'], en: ['Antibiotic-free', 'Free range']}
                }
            ];
            ...
            alert('✅ Test verileri başarıyla eklendi!');
            refetch();
        } catch (error) {
